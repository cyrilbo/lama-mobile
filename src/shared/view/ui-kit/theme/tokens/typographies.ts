...
export const typographies = {
  Tagline: {
    L: {
      ...
      fontSize: typographie.font.size["4xl"],
      fontStyle: "normal",
      fontWeight: 800,
      lineHeight: typographie.font.size["4xl"] * 1.35,
    },
    M: {
      fontFamily: typographie.font.family.tagline,
  ...
  Title: {
    H1: {
      ...
      fontStyle: "normal",
      fontWeight: 700,
      lineHeight: typographie.font.size["2xl"] * 1.4,
    },
    H2: {
      fontFamily: typographie.font.family.title,
    ...
    H4: {
      ...
      fontStyle: "normal",
      fontWeight: 400,
      lineHeight: typographie.font.size["md"] * 1.45,
      letterSpacing: 0.32,
  ...
  Text: {
    P1: {
      Label: {
        ...
        fontStyle: "normal",
        fontWeight: 500,
        lineHeight: typographie.font.size["md"] * 1.5,
      },
      Paragraph: {
        fontFamily: typographie.font.family.text,
        fontSize: typographie.font.size["md"],
    ...
    P2: {
      Label: {
        ...
        fontStyle: "normal",
        fontWeight: 500,
        lineHeight: typographie.font.size["sm"] * 1.4,
      },
      Paragraph: {
        fontFamily: typographie.font.family.text,
        fontSize: typographie.font.size["sm"],
